...
if (-not $Nested) {
    Write-Host 'PS2EXE-GUI v0.6.2.0 by Ingo Karstein'
...
if ($NoConsole) {
    ...
    [void]$framework.AppendLine()
    [void]$framework.AppendLine('        struct ProgressData')
    [void]$framework.AppendLine('        {')
    [void]$framework.AppendLine('            internal Label lblActivity;')
    [void]$framework.AppendLine('            internal Label lblStatus;')
    [void]$framework.AppendLine('            internal ProgressBar objProgressBar;')
    [void]$framework.AppendLine('            internal Label lblRemainingTime;')
    [void]$framework.AppendLine('            internal Label lblOperation;')
    [void]$framework.AppendLine('            internal int ActivityId;')
    [void]$framework.AppendLine('            internal int ParentActivityId;')
    [void]$framework.AppendLine('            internal int Depth;')
    [void]$framework.AppendLine('        };')

    [void]$framework.AppendLine()
    [void]$framework.AppendLine('        private List<ProgressData> progressDataList = new List<ProgressData>();')
    ...
    [void]$framework.AppendLine()
    [void]$framework.AppendLine('            this.AutoScroll = true;')
    [void]$framework.AppendLine('            this.Text = System.AppDomain.CurrentDomain.FriendlyName;')
    ...
    [void]$framework.AppendLine('            this.ControlBox = false;')
    ...
    [void]$framework.AppendLine()
    [void]$framework.AppendLine('        private void AddBar(ref ProgressData pd, int position)')
    [void]$framework.AppendLine('        {')
    [void]$framework.AppendLine('            // Create Label')
    [void]$framework.AppendLine('            pd.lblActivity = new Label();')
    [void]$framework.AppendLine('            pd.lblActivity.Left = 5;')
    [void]$framework.AppendLine('            pd.lblActivity.Top = 104 * position + 10;')
    [void]$framework.AppendLine('            pd.lblActivity.Width = 800 - 20;')
    [void]$framework.AppendLine('            pd.lblActivity.Height = 16;')
    [void]$framework.AppendLine('            pd.lblActivity.Font = new Font(pd.lblActivity.Font, FontStyle.Bold);')
    [void]$framework.AppendLine('            pd.lblActivity.Text = "";')
    [void]$framework.AppendLine('            // Add Label to Form')
    [void]$framework.AppendLine('            this.Controls.Add(pd.lblActivity);')

    [void]$framework.AppendLine()
    [void]$framework.AppendLine('            // Create Label')
    [void]$framework.AppendLine('            pd.lblStatus = new Label();')
    [void]$framework.AppendLine('            pd.lblStatus.Left = 25;')
    [void]$framework.AppendLine('            pd.lblStatus.Top = 104 * position + 26;')
    [void]$framework.AppendLine('            pd.lblStatus.Width = 800 - 40;')
    [void]$framework.AppendLine('            pd.lblStatus.Height = 16;')
    [void]$framework.AppendLine('            pd.lblStatus.Text = "";')
    [void]$framework.AppendLine('            // Add Label to Form')
    [void]$framework.AppendLine('            this.Controls.Add(pd.lblStatus);')

    [void]$framework.AppendLine()
    [void]$framework.AppendLine('            // Create ProgressBar')
    [void]$framework.AppendLine('            pd.objProgressBar = new ProgressBar();')
    [void]$framework.AppendLine('            pd.objProgressBar.Value = 0;')

    if ($NoVisualStyles) {
        [void]$framework.AppendLine('            pd.objProgressBar.Style = ProgressBarStyle.Continuous;')
    }
    else {
        [void]$framework.AppendLine('            pd.objProgressBar.Style = ProgressBarStyle.Blocks;')
    }

    [void]$framework.AppendLine('            pd.objProgressBar.ForeColor = DrawingColor(ProgressBarColor);')

    [void]$framework.AppendLine()
    [void]$framework.AppendLine('            if (pd.Depth < 15)')
    [void]$framework.AppendLine('            {')
    [void]$framework.AppendLine('                pd.objProgressBar.Size = new System.Drawing.Size(800 - 60 - 30 * pd.Depth, 20);')
    [void]$framework.AppendLine('                pd.objProgressBar.Left = 25 + 30 * pd.Depth;')
    [void]$framework.AppendLine('            }')
    [void]$framework.AppendLine('            else')
    [void]$framework.AppendLine('            {')
    [void]$framework.AppendLine('                pd.objProgressBar.Size = new System.Drawing.Size(800 - 60 - 450, 20);')
    [void]$framework.AppendLine('                pd.objProgressBar.Left = 25 + 450;')
    [void]$framework.AppendLine('            }')

    [void]$framework.AppendLine()
    [void]$framework.AppendLine('            pd.objProgressBar.Top = 104 * position + 47;')
    [void]$framework.AppendLine('            // Add ProgressBar to Form')
    [void]$framework.AppendLine('            this.Controls.Add(pd.objProgressBar);')

    [void]$framework.AppendLine()
    [void]$framework.AppendLine('            // Create Label')
    [void]$framework.AppendLine('            pd.lblRemainingTime = new Label();')
    [void]$framework.AppendLine('            pd.lblRemainingTime.Left = 5;')
    [void]$framework.AppendLine('            pd.lblRemainingTime.Top = 104 * position + 72;')
    [void]$framework.AppendLine('            pd.lblRemainingTime.Width = 800 - 20;')
    [void]$framework.AppendLine('            pd.lblRemainingTime.Height = 16;')
    [void]$framework.AppendLine('            pd.lblRemainingTime.Text = "";')
    [void]$framework.AppendLine('            // Add Label to Form')
    [void]$framework.AppendLine('            this.Controls.Add(pd.lblRemainingTime);')

    [void]$framework.AppendLine()
    [void]$framework.AppendLine('            // Create Label')
    [void]$framework.AppendLine('            pd.lblOperation = new Label();')
    [void]$framework.AppendLine('            pd.lblOperation.Left = 25;')
    [void]$framework.AppendLine('            pd.lblOperation.Top = 104 * position + 88;')
    [void]$framework.AppendLine('            pd.lblOperation.Width = 800 - 40;')
    [void]$framework.AppendLine('            pd.lblOperation.Height = 16;')
    [void]$framework.AppendLine('            pd.lblOperation.Text = "";')
    [void]$framework.AppendLine('            // Add Label to Form')
    [void]$framework.AppendLine('            this.Controls.Add(pd.lblOperation);')
    [void]$framework.AppendLine('        }')

    [void]$framework.AppendLine()
    [void]$framework.AppendLine('        public int GetCount()')
    [void]$framework.AppendLine('        {')
    [void]$framework.AppendLine('            return progressDataList.Count;')
    [void]$framework.AppendLine('        }')
    ...
    [void]$framework.AppendLine()
    [void]$framework.AppendLine('            int currentProgress = -1;')
    [void]$framework.AppendLine('            for (int i = 0; i < progressDataList.Count; i++)')
    [void]$framework.AppendLine('            {')
    [void]$framework.AppendLine('                if (progressDataList[i].ActivityId == objRecord.ActivityId)')
    [void]$framework.AppendLine('                {')
    [void]$framework.AppendLine('                    currentProgress = i;')
    ...
    [void]$framework.AppendLine('            {')
    [void]$framework.AppendLine('                if (currentProgress < 0) return;')

    [void]$framework.AppendLine()
    [void]$framework.AppendLine('                this.Controls.Remove(progressDataList[currentProgress].lblActivity);')
    [void]$framework.AppendLine('                this.Controls.Remove(progressDataList[currentProgress].lblStatus);')
    [void]$framework.AppendLine('                this.Controls.Remove(progressDataList[currentProgress].objProgressBar);')
    [void]$framework.AppendLine('                this.Controls.Remove(progressDataList[currentProgress].lblRemainingTime);')
    [void]$framework.AppendLine('                this.Controls.Remove(progressDataList[currentProgress].lblOperation);')

    [void]$framework.AppendLine()
    [void]$framework.AppendLine('                progressDataList[currentProgress].lblActivity.Dispose();')
    [void]$framework.AppendLine('                progressDataList[currentProgress].lblStatus.Dispose();')
    [void]$framework.AppendLine('                progressDataList[currentProgress].objProgressBar.Dispose();')
    [void]$framework.AppendLine('                progressDataList[currentProgress].lblRemainingTime.Dispose();')
    [void]$framework.AppendLine('                progressDataList[currentProgress].lblOperation.Dispose();')
    [void]$framework.AppendLine('                progressDataList.RemoveAt(currentProgress);')

    [void]$framework.AppendLine()
    [void]$framework.AppendLine('                if (progressDataList.Count == 0)')
    [void]$framework.AppendLine('                {')
    [void]$framework.AppendLine('                    this.Close();')
    [void]$framework.AppendLine('                    return;')
    [void]$framework.AppendLine('                }')
    ...
    [void]$framework.AppendLine()
    [void]$framework.AppendLine('                for (int i = currentProgress; i < progressDataList.Count; i++)')
    [void]$framework.AppendLine('                {')
    [void]$framework.AppendLine('                    progressDataList[i].lblActivity.Top = 104 * i + 10;')
    [void]$framework.AppendLine('                    progressDataList[i].lblStatus.Top = 104 * i + 26;')
    [void]$framework.AppendLine('                    progressDataList[i].objProgressBar.Top = 104 * i + 47;')
    [void]$framework.AppendLine('                    progressDataList[i].lblRemainingTime.Top = 104 * i + 72;')
    [void]$framework.AppendLine('                    progressDataList[i].lblOperation.Top = 104 * i + 88;')
    [void]$framework.AppendLine('                }')

    [void]$framework.AppendLine()
    [void]$framework.AppendLine('                if (104 * progressDataList.Count + 43 <= System.Windows.Forms.Screen.FromControl(this).Bounds.Height)')
    [void]$framework.AppendLine('                {')
    [void]$framework.AppendLine('                    this.Height = 104 * progressDataList.Count + 43;')
    [void]$framework.AppendLine('                    this.Location = new Point((System.Windows.Forms.Screen.FromControl(this).Bounds.Width - this.Width) / 2, (System.Windows.Forms.Screen.FromControl(this).Bounds.Height - this.Height) / 2);')
    [void]$framework.AppendLine('                }')
    [void]$framework.AppendLine('                else')
    [void]$framework.AppendLine('                {')
    [void]$framework.AppendLine('                    this.Height = System.Windows.Forms.Screen.FromControl(this).Bounds.Height;')
    [void]$framework.AppendLine('                    this.Location = new Point((System.Windows.Forms.Screen.FromControl(this).Bounds.Width - this.Width) / 2, 0);')
    [void]$framework.AppendLine('                }')
    ...
    [void]$framework.AppendLine()
    [void]$framework.AppendLine('            if (currentProgress < 0)')
    [void]$framework.AppendLine('            {')
    [void]$framework.AppendLine('                ProgressData pd = new ProgressData();')
    [void]$framework.AppendLine('                pd.ActivityId = objRecord.ActivityId;')
    [void]$framework.AppendLine('                pd.ParentActivityId = objRecord.ParentActivityId;')
    [void]$framework.AppendLine('                pd.Depth = 0;')
    [void]$framework.AppendLine('                int nextid = -1;')
    [void]$framework.AppendLine('                int parentid = -1;')

    [void]$framework.AppendLine()
    [void]$framework.AppendLine('                if (pd.ParentActivityId >= 0)')
    [void]$framework.AppendLine('                {')
    [void]$framework.AppendLine('                    for (int i = 0; i < progressDataList.Count; i++)')
    [void]$framework.AppendLine('                    {')
    [void]$framework.AppendLine('                        if (progressDataList[i].ActivityId == pd.ParentActivityId)')
    [void]$framework.AppendLine('                        {')
    [void]$framework.AppendLine('                            parentid = i;')
    [void]$framework.AppendLine('                            break;')
    [void]$framework.AppendLine('                        }')
    [void]$framework.AppendLine('                    }')
    [void]$framework.AppendLine('                }')
    ...
    [void]$framework.AppendLine()
    [void]$framework.AppendLine('                if (parentid >= 0)')
    [void]$framework.AppendLine('                {')
    [void]$framework.AppendLine('                    pd.Depth = progressDataList[parentid].Depth + 1;')
    [void]$framework.AppendLine('                    for (int i = parentid + 1; i < progressDataList.Count; i++)')
    [void]$framework.AppendLine('                    {')
    [void]$framework.AppendLine('                        if ((progressDataList[i].Depth < pd.Depth) || ((progressDataList[i].Depth == pd.Depth) && (progressDataList[i].ParentActivityId != pd.ParentActivityId)))')
    [void]$framework.AppendLine('                        {')
    [void]$framework.AppendLine('                            nextid = i;')
    [void]$framework.AppendLine('                            break;')
    [void]$framework.AppendLine('                        }')
    [void]$framework.AppendLine('                    }')
    [void]$framework.AppendLine('                }')
    ...
    [void]$framework.AppendLine()
    [void]$framework.AppendLine('                if (nextid == -1)')
    [void]$framework.AppendLine('                {')
    [void]$framework.AppendLine('                    AddBar(ref pd, progressDataList.Count);')
    [void]$framework.AppendLine('                    currentProgress = progressDataList.Count;')
    [void]$framework.AppendLine('                    progressDataList.Add(pd);')
    [void]$framework.AppendLine('                }')
    [void]$framework.AppendLine('                else')
    [void]$framework.AppendLine('                {')
    [void]$framework.AppendLine('                    AddBar(ref pd, nextid);')
    [void]$framework.AppendLine('                    currentProgress = nextid;')
    [void]$framework.AppendLine('                    progressDataList.Insert(nextid, pd);')
    [void]$framework.AppendLine('                    for (int i = currentProgress + 1; i < progressDataList.Count; i++)')
    [void]$framework.AppendLine('                    {')
    [void]$framework.AppendLine('                        progressDataList[i].lblActivity.Top = 104 * i + 10;')
    [void]$framework.AppendLine('                        progressDataList[i].lblStatus.Top = 104 * i + 26;')
    [void]$framework.AppendLine('                        progressDataList[i].objProgressBar.Top = 104 * i + 47;')
    ...
    [void]$framework.AppendLine('                progressDataList[currentProgress].lblActivity.Text = objRecord.Activity;')
    [void]$framework.AppendLine('            else')
    [void]$framework.AppendLine('                progressDataList[currentProgress].lblActivity.Text = "";')

    [void]$framework.AppendLine()
    [void]$framework.AppendLine('            if (!string.IsNullOrEmpty(objRecord.StatusDescription))')
    [void]$framework.AppendLine('                progressDataList[currentProgress].lblStatus.Text = objRecord.StatusDescription;')
    [void]$framework.AppendLine('            else')
    [void]$framework.AppendLine('                progressDataList[currentProgress].lblStatus.Text = "";')

    [void]$framework.AppendLine()
    [void]$framework.AppendLine('            if ((objRecord.PercentComplete >= 0) && (objRecord.PercentComplete <= 100))')
    [void]$framework.AppendLine('            {')
    [void]$framework.AppendLine('                progressDataList[currentProgress].objProgressBar.Value = objRecord.PercentComplete;')
    [void]$framework.AppendLine('                progressDataList[currentProgress].objProgressBar.Visible = true;')
    [void]$framework.AppendLine('            }')
    [void]$framework.AppendLine('            else')
    [void]$framework.AppendLine('            {')
    [void]$framework.AppendLine('                if (objRecord.PercentComplete > 100)')
    [void]$framework.AppendLine('                {')
    [void]$framework.AppendLine('                    progressDataList[currentProgress].objProgressBar.Value = 0;')
    [void]$framework.AppendLine('                    progressDataList[currentProgress].objProgressBar.Visible = true;')
    [void]$framework.AppendLine('                }')
    [void]$framework.AppendLine('                else')
    [void]$framework.AppendLine('                    progressDataList[currentProgress].objProgressBar.Visible = false;')
    [void]$framework.AppendLine('            }')
    ...
    [void]$framework.AppendLine('                progressDataList[currentProgress].lblRemainingTime.Text = "Remaining time: " + string.Format("{0:00}:{1:00}:{2:00}", (int)objTimeSpan.TotalHours, objTimeSpan.Minutes, objTimeSpan.Seconds);')
    [void]$framework.AppendLine('            }')
    [void]$framework.AppendLine('            else')
    [void]$framework.AppendLine('                progressDataList[currentProgress].lblRemainingTime.Text = "";')

    [void]$framework.AppendLine()
    [void]$framework.AppendLine('            if (!string.IsNullOrEmpty(objRecord.CurrentOperation))')
    [void]$framework.AppendLine('                progressDataList[currentProgress].lblOperation.Text = objRecord.CurrentOperation;')
    [void]$framework.AppendLine('            else')
    [void]$framework.AppendLine('                progressDataList[currentProgress].lblOperation.Text = "";')
...
if ($NoConsole) {
    ...
    [void]$framework.AppendLine('            {')
    [void]$framework.AppendLine('                if (pf.GetCount() == 0) pf = null;')
    [void]$framework.AppendLine('            }')
}
...
[void]$framework.AppendLine('        {')
[void]$framework.AppendLine('            get { return new Version(0, 6, 2, 0); }')
[void]$framework.AppendLine('        }')
